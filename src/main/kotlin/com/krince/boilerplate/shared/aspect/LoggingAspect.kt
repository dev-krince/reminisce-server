package com.krince.boilerplate.shared.aspect

import com.krince.boilerplate.shared.annotation.Loggable
import com.krince.boilerplate.shared.annotation.Loggable.LogLevel
...
class LoggingAspect {
    ...
    @Around(//TODO 프로젝트에 맞게 변경
        """
         (execution(* com.krince.boilerplate.application.service..*.*(..)) ||
         execution(* com.krince.boilerplate.application.port..*.*(..)) ||
         execution(* com.krince.boilerplate.infra.adapter.out.persistence..*.*(..)) ||
         execution(* com.krince.boilerplate.infra.adapter.in.controller..*.*(..)))
        && !@annotation(com.krince.boilerplate.shared.annotation.Loggable) 
        && !@within(com.krince.boilerplate.shared.annotation.Loggable)
