...
import com.krince.boilerplate.infra.swagger.ExampleHolder
...
import com.krince.boilerplate.shared.response.PageResponse
...
class SwaggerConfig(
    ...
    companion object {
        ...
        private const val PROJECT_TITLE_NAME = "Boilerplate API"
        private const val SWAGGER_DESCRIPTION = "Boilerplate API 인터페이스 명세서"
        ...
        try {
            ...
            for (field in fields) {
                ...
                val propertySchema = when {
                            ...
                            if (typeArgs.isNotEmpty() && typeArgs[0] is Class<*>) {
                                ...
                                val itemSchema = when (itemClass) {
                                    ...
                                    Float::class.java, Float::class.javaPrimitiveType -> MediaSchema<Float>().type("number").format("float").example(0.0f)
                                        ...
                                        if (itemClass.name.startsWith("com.krince.boilerplate")) { //TODO 변경
                    ...
                    // 중첩된 DTO 클래스인 경우
                    fieldType.name.startsWith("com.krince.boilerplate") && !fieldType.isPrimitive && !fieldType.isInterface -> { //TODO 변경
