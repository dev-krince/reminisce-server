...
interface StoryWordController {

    @Operation(
        summary = "이야기에서 만난 단어 조회",
        description = "아이가 이야기에서 만난 단어를 이야기별 그룹으로 조회합니다. 단어마다 아이 눈높이 뜻·삽화 이미지·발음 오디오를 함께 제공합니다.",
    )
    @SwaggerSuccessResponse(responseCode = OK, description = "이야기에서 만난 단어 조회 성공")
