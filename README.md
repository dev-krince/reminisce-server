...
PCN 프로젝트 `reminisce` 서버 애플리케이션. Kotlin + Spring Boot 기반 헥사고날 구조와 인증·응답·테스트 정책을 정의합니다.
...
```
src/main/kotlin/com/pcn/reminisce/
├── domain/          # 도메인 모델, VO
...
자세한 레이어·정책은 **[docs/REMINISCE_POLICY.md](docs/REMINISCE_POLICY.md)** 참고.
...
이 프로젝트의 아키텍처·API·보안·테스트 정책은 **[docs/REMINISCE_POLICY.md](docs/REMINISCE_POLICY.md)** 에 정의되어 있습니다. 코드 작성·리뷰 시 해당 문서와 체크리스트를 따라 주세요.
